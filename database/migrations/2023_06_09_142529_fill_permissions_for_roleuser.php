...
class FillPermissionsForRoleuser extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRoleuser constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.roleuser',
            'admin.roleuser.index',
            'admin.roleuser.create',
            'admin.roleuser.show',
            'admin.roleuser.edit',
            'admin.roleuser.delete',
            'admin.roleuser.bulk-delete',
        ]);
