...
class FillPermissionsForTipoServicio extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTipoServicio constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tipo-servicio',
            'admin.tipo-servicio.index',
            'admin.tipo-servicio.create',
            'admin.tipo-servicio.show',
            'admin.tipo-servicio.edit',
            'admin.tipo-servicio.delete',
            'admin.tipo-servicio.bulk-delete',
        ]);
